...
export declare namespace TronPaySubscription {
...
export interface TronPaySubscriptionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "activate"
      | "cancelSubscription"
...
export interface TronPaySubscription extends BaseContract {
  connect(runner?: ContractRunner | null): TronPaySubscription;
  waitForDeployment(): Promise<this>;

  interface: TronPaySubscriptionInterface;
  ...
  getSubscription: TypedContractMethod<
    [_subscriptionId: BigNumberish],
    [TronPaySubscription.SubscriptionStructOutput],
    "view"
  >;
