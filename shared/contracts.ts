...
export const NETWORK_TOKENS: NetworkTokens[] = [
  ...
  // ── TRON Networks ────────────────────────────────────────────────────────────
  // TRON tokens use Base58Check T-prefix addresses (not 0x-prefixed EVM addresses).
  // subscriptionContract populated after TronPaySubscription.sol is deployed.
  {
  ...
  },
  {
    ...
    tokens: [
      { symbol: "USDT", name: "Test Tether USD", address: "TXYZopYRdj2D9XRtbG411XZZ3kM5VkAeBf", decimals: 6 },
    ],
    subscriptionContract: undefined, // Set after Nile deployment
  },
];
